...
public class GetSubscriptionRsp  implements java.io.Serializable {
    ...
    private utils.portalEngine.rsp.SubInfo[] subInfo;
    ...
    public GetSubscriptionRsp(
           ...
           utils.portalEngine.rsp.SubInfo[] subInfo) {
     ...
     * @return subInfo
     */
    public utils.portalEngine.rsp.SubInfo[] getSubInfo() {
        return subInfo;
    }
     ...
     * @param subInfo
     */
    public void setSubInfo(utils.portalEngine.rsp.SubInfo[] subInfo) {
        this.subInfo = subInfo;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rsp.portalEngine.ismp.chinatelecom.com", "GetSubscriptionRsp"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://rsp.portalEngine.ismp.chinatelecom.com", "subInfo"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://rsp.portalEngine.ismp.chinatelecom.com", "SubInfo"));
        elemField.setNillable(true);

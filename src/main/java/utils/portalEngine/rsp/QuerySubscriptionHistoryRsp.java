...
public class QuerySubscriptionHistoryRsp  implements java.io.Serializable {
    ...
    private utils.portalEngine.rsp.SubHistoryInfo[] subHistoryInfo;
    ...
    public QuerySubscriptionHistoryRsp(
           ...
           utils.portalEngine.rsp.SubHistoryInfo[] subHistoryInfo) {
     ...
     */
    public utils.portalEngine.rsp.SubHistoryInfo[] getSubHistoryInfo() {
        return subHistoryInfo;
    }
     ...
     */
    public void setSubHistoryInfo(utils.portalEngine.rsp.SubHistoryInfo[] subHistoryInfo) {
        this.subHistoryInfo = subHistoryInfo;
    }

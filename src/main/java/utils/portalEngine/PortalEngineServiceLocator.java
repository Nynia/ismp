...
public class PortalEngineServiceLocator extends org.apache.axis.client.Service implements utils.portalEngine.PortalEngineService {
    ...
    public utils.portalEngine.PortalEngine getPortalEngine(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            utils.portalEngine.PortalEngineSoapBindingStub _stub = new utils.portalEngine.PortalEngineSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (utils.portalEngine.PortalEngine.class.isAssignableFrom(serviceEndpointInterface)) {
                utils.portalEngine.PortalEngineSoapBindingStub _stub = new utils.portalEngine.PortalEngineSoapBindingStub(new java.net.URL(PortalEngine_address), this);
                _stub.setPortName(getPortalEngineWSDDServiceName());
                return _stub;
            }
        }
